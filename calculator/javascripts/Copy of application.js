var pavings = [
  {name:'Cobblestone', value: '7.5', img: 'images/photo1.jpg'}, 
  {name:'Belgian Cobblestone', value: '11', img: 'images/photo2.jpg'},
  {name:'Slatestone', value: '14', img: 'images/photo3.jpg'}
];
...
function refreshEstimate()
{
  ...
  $("h1#cost").html("$" + estimate);
  $("input#paving-cost").attr('value', "$" + formatCurrency(estimate));
}
